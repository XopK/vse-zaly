<x-layout>
                                        ...
                                        <ul class="check-sel-droplist">
                                            ...
                                            <li>
                                                ...
                                                <div class="clearfix">
                                                    ...
                                                    <div class="radio-block child-block"><input type="radio"
                                                            name="child-group" id="radio-6"
                                                            value="2 Children"><label for="radio-6">2</label></div>
                                                    <div class="radio-block child-block"><input type="radio"
                                                            name="child-group" id="radio-7"
                                                            value="3 Children"><label for="radio-7">3</label></div>
                                                    <div class="radio-block child-block"><input type="radio"
                                                            name="child-group" id="radio-8"
                                                            value="4 Children"><label for="radio-8">4</label></div>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                ...
                <div class="text-column col-lg-6 col-md-12 col-sm-12">
                    <div class="inner">
                        ...
                        <div class="text">Найди зал который будет ближе всего к тебе и скорее бронируй! <br>
                            ...
                            а именно: танцевальные залы, фотостудии, репетиционные залы и т.д.
                        </div>
                        {{-- <div class="link-box">
    ...
    <section class="rooms-section-one">
        <div class="outer-container">
            ...
            <div class="row clearfix">
                @forelse($studios->chunk(2) as $chunk)
                                ...
                                <div class="inner-box">
                                    <div class="image-box">
                                        <div class="image-layer"
                                             style="background-image: url(/storage/photo_studios/{{$studio->photo_studio}});">
                                        </div>
                                        <figure class="image"><img
                                                src="/storage/photo_studios/{{$studio->photo_studio}}"
                                                alt="{{$studio->photo_studio}}"
                                                title="{{$studio->name_studio}}"></figure>
                                    </div>
                                    <div class="cap-box">
                                        <div class="cap-inner">
                                            {{-- <div class="price">Студия <span>MAIN</span></div> --}}
                                            <h5>Студия {{$studio->name_studio}}</h5>
                                        </div>
                                    </div>
                                    <div class="hover-box">
                                        <div class="hover-inner">
                                            ...
                                            <div class="link-box"><a
                                                    href="/about_studio/{{$studio->id}}-{{Str::slug($studio->name_studio)}}"
        ...
        <div class="auto-container">
            <div class="row clearfix">
                ...
                <div class="text-column col-lg-6 col-md-12 col-sm-12">
                    <div class="inner">
                        <div class="sec-title">
                            <h2>Мы работаем только с проверенными студиями</h2>
                        </div>
    ...
    {{-- <section class="offers-section-one">
        <div class="auto-container">
            ...
            <div class="upper-box clearfix">
                ...
                <div class="link-box">
                    <a href="packages.html" class="theme-btn btn-style-one"><span class="btn-title">View All
                            Offers</span></a>
                </div>
            </div>
                    ...
                    <div class="inner">
                        <div class="offer-block">
                            <div class="offer-inner">
                                <div class="fact-thumb wow zoomInStable" data-wow-delay="0ms"
                                    data-wow-duration="1500ms">
                                    <div class="image"><img src="images/resource/of-thumb-1.jpg" alt=""
                                            title=""></div><span>30% <br>off</span>
                                </div>
                        ...
                        <div class="offer-block">
                            <div class="offer-inner">
                                <div class="fact-thumb wow zoomInStable" data-wow-delay="300ms"
                                    data-wow-duration="1500ms">
                                    <div class="image"><img src="images/resource/of-thumb-1.jpg" alt=""
                                            title=""></div><span>30% <br>off</span>
                                </div>
                        ...
                        <div class="offer-block">
                            <div class="offer-inner">
                                <div class="fact-thumb wow zoomInStable" data-wow-delay="600ms"
                                    data-wow-duration="1500ms">
                                    <div class="image"><img src="images/resource/of-thumb-1.jpg" alt=""
                                            title=""></div><span>30% <br>off</span>
                                </div>
                        ...
                        <div class="inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <div class="image-box">
                                <figure class="image"><a href="#"><img
                                            src="images/resource/featured-image-4.jpg" alt=""
                                            title=""></a></figure>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="text-column col-lg-6 col-md-12 col-sm-12">
                        <div class="inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                            ...
                            <div class="text">Lorem ipsum dolor sit amet constur adipisicing elit sed do eiusmtem por
                                ...
                                nisi ut aliquip excepteur.</div>
                            <div class="link-box">
                                <a href="about.html" class="theme-btn btn-style-one"><span class="btn-title">Discover
                                        Now</span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="image-column col-lg-6 col-md-12 col-sm-12">
                        <div class="inner wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <div class="image-box">
                                <figure class="image"><a href="#"><img
                                            src="images/resource/featured-image-5.jpg" alt=""
                                            title=""></a></figure>
                            </div>
                        </div>
                    </div>
    ...
    {{-- <section class="video-section">
        ...
        <div class="auto-container">
            <div class="content-box wow zoomIn" data-wow-delay="0ms" data-wow-duration="2000ms">
                ...
                <div class="play-link"><a href="https://www.youtube.com/watch?v=Get7rqXYrbQ"
                            ...
                            <div class="content-box">
                                <div class="content">
                                    ...
                                    <div class="text">Lorem ipsum dolor sit amet consectetur adipis elit eiusmod
                                        tempor incidunt sed labore dolore magna.</div>
                                </div>
                            </div>
    ...
    {{-- <section class="news-section">
        ...
        <div class="auto-container">
            <div class="upper-box clearfix">
                ...
                <div class="link-box">
                    <a href="blog.html" class="theme-btn btn-style-one"><span class="btn-title">View All
                            Post</span></a>
                </div>
            </div>
            <div class="row clearfix">
                    ...
                    <div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="image-box">
                            <figure class="image"><a href="blog-single.html"><img
                                        src="images/resource/news-image-1.jpg" alt="" title=""></a>
                            </figure>
                        </div>
                        <div class="post-meta">
                ...
                <div class="news-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="image-box">
                            <figure class="image"><a href="blog-single.html"><img
                                        src="images/resource/news-image-2.jpg" alt="" title=""></a>
                            </figure>
                        </div>
                        <div class="post-meta">
                            <span>on 2 Sep, 2019 / by admin</span>
                ...
                <div class="news-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="image-box">
                            <figure class="image"><a href="blog-single.html"><img
                                        src="images/resource/news-image-3.jpg" alt="" title=""></a>
                            </figure>
                        </div>
                        <div class="post-meta">
                            <span>on 2 Sep, 2019 / by admin</span>
