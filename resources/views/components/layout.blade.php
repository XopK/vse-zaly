    ...
    <header class="main-header header-style-one">
        ...
        <div class="header-upper">
            <div class="inner-container clearfix">
                <!--Logo-->
                <div class="logo-box">
                    <div class="logo"><a href="/" title="Аренда залов в Уфе"><img src="/images/black-logo.png"
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <ul class="info">
                                            ...
                                            <li class="email"><a
                                                    href="mailto:no-reply@vsezaly.ru">no-reply@vsezaly.ru</a></li>
                            ...
                            <div class="newsletter-form">
                                <form method="post" action="contact.html">
                                    <div class="form-group clearfix">
                                        ...
                                        <button type="submit" class="theme-btn btn-style-one"><span class="btn-title">Отправить</span>
                                        </button>
                                    </div>
                                </form>
                            </div>
