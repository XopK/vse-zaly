        ...
        <div class="cd-tab-filter-wrapper">
            <div class="cd-tab-filter">
                <ul class="cd-filters">
                    ...
                    <li class="filter" data-filter=".color-1"><a href="#0" data-type="color-1">По возрастанию цены</a>
                    </li>
                    ...
                    <div class="inner-box">
                        ...
                        <div class="lower-box">
                            ...
                            <div class="link-box"><a href="/hall/{{$hall->id}}-{{Str::slug($hall->name_hall)}}"
                                                     class="theme-btn btn-style-three"><span class="btn-title">Просмотреть</span></a>
                            </div>
                        </div>
                    </div>
                </div>
