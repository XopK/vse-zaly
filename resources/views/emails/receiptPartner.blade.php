...
>
<head>
    <title> Заказ №{{$lastBooking->id}} </title>
    <!--[if !mso]><!-- -->
...
<div style="background-color:#f3f3f5;">
    ...
    >
        <tr>
            <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
    <![endif]-->
    <div style="background:#181b1f;background-color:#181b1f;margin:0px auto;border-radius:4px 4px 0 0;max-width:600px;">
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
               style="background:#181b1f;background-color:#181b1f;width:100%;border-radius:4px 4px 0 0;">
            <tbody>
            <tr>
                <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;">
                    <!--[if mso | IE]>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                            ...
                                            <tr>
                                                <td align="center"
                                                    ...
                                                    <div
                                                        style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;line-height:20px;text-align:center;color:#aaaaaa;">
                                                        <p style="margin: 0;">Номер чека: {{$lastBooking->id}} | Дата
                                                            создания:
                                                            {{ date('d.m.Y H:i', strtotime($lastBooking->created_at)) }} </p>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td align="left"
                                                    ...
                                                    <div
                                                        ...
                                                        <p style="margin: 0;">Здравствуйте, {{$lastBooking->user->name}}
                                                            !<br/>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                            ...
                                            <tr>
                                                <td style="vertical-align:top;padding:0px 25px;">
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                           role="presentation" style="background-color:#34393E;"
                                                           width="100%">
                                                        <tbody>
                                                        <tr>
                                                            <td align="left" class="receipt-table"
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <th colspan="3"
                                                                            style="font-size: 20px; line-height: 30px; font-weight: 500; color: #fff; padding: 0px 0px 10px 0px; text-align: center; border-bottom: 1px solid #555;"
                                                                            align="center">Детали заказа
                                                                        </th>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        <td style="word-break: break-word; color: #fff; font-size: 20px; line-height: 30px; border-top: 1px solid #555; font-weight: 500; padding: 10px 0px 0px 0px; text-align: left;"
                                                                            colspan="2" align="left">Итого:
                                                                        </td>
                                                                        <td style="word-break: break-word; color: #fff; font-size: 20px; line-height: 30px; border-top: 1px solid #555; font-weight: 500; text-align: right; padding: 10px 0px 0px 0px;"
                                                                            align="right">{{ collect($bookings)->sum('total_price') }}
                                                                            ₽
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                ...
                                                <tr>
                                                    <td align="left"
                                                        ...
                                                        <div
                                                            style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;line-height:20px;text-align:left;color:#ffffff;">
                                                            <p style="margin: 0;">Вы получаете это письмо, потому что
                                                                совершили покупку в vsezaly.ru.
                                                            </p>
                                                        </div>
                                                    </td>
                                                </tr>
