...
<head>
    <title> Заявка {{$status ? 'принята' : 'отклонена'}}</title>
    <!--[if !mso]><!-- -->
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
            ...
            <tr>
                <td style="direction:ltr;font-size:0px;padding:0 20px;text-align:center;">
                    ...
                    @if($status == false)
                        <div
                            style="background:#dd5029;background-color:#dd5029;margin:0px auto;border-radius:4px;max-width:560px;">
                            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                                   style="background:#dd5029;background-color:#dd5029;width:100%;border-radius:4px;">
                                <tbody>
                                <tr>
                                                ...
                                                <tr>
                                                    <td align="left"
                                                        ...
                                                        <div
                                                            ...
                                                            <p style="margin: 0;">К сожалению, ваша заявка на получение
                                                                статуса "Партнёр" была отклонена. Мы ценим ваше внимание
                                                                к
                                                                нашему предложению, однако в данный момент вы не
                                                                соответствуете необходимым критериям для присвоения
                                                                статуса.</p>
                                                        </div>
                                                    </td>
                                                </tr>
                    ...
                    <!--[if mso | IE]>
                        ...
                        @if($status)
                            <div
                                style="background:#5cc53c;background-color:#5cc53c;margin:0px auto;border-radius:4px;max-width:560px;">
                                <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                                       style="background:#5cc53c;background-color:#5cc53c;width:100%;border-radius:4px;">
                                    <tbody>
                                    <tr>
                                        <td style="direction:ltr;font-size:0px;padding:5px;text-align:center;">
                                            <!--[if mso | IE]>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    ...
                                                    <tr>
                                                        <td align="left"
                                                            ...
                                                            <div
                                                                style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;line-height:20px;text-align:left;color:#ffffff;">
                                                                <p style="margin: 0;">Рады сообщить, что ваша заявка на
                                                                    получение статуса "Партнёр" была успешно одобрена!
                                                                    Теперь
                                                                    для вас стал доступен функционал студий на нашем
                                                                    сайте. </p>
                                                            </div>
                                                        </td>
                                                    </tr>
