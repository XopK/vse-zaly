                                ...
                                <td align="center" style="padding: 10px 25px;">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <p style="margin-bottom: 10px; font-size: 17px;">Ваш код подтверждения:</p>
                                            <div
                                                style="font-size: 24px; font-weight: bold; color: #d81a67;">{{ $verificationCode }}
                                            </div>
                                            <p style="margin-top: 15px; font-size: 14px;">Пожалуйста, используйте этот
                                                код для подтверждения вашей учетной записи. Этот код действителен в
                                                течение 15 минут.</p>
                                        </div>
                                    </div>
                                </td>
